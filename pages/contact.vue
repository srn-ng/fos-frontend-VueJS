  ...
  <v-card style="margin-top: -20px" class="pb-5" fluid elevation="0">
    <div>
      ...
      <div
        ...
        "
      >
        <v-row fluid class="outerdiv">
          <v-col cols="2" class="text-center">
            <p style="color: white; font-family: 'Montserrat'">
              Nous sommes là pour répondre à toutes vos questions et recevoir
              ...
              <v-container>
                ...
                <v-row>
                  <v-col class="d-flex justify-end">
                    <!-- <button color="primary" dark>Submit</button> -->
      ...
      <div class="div-btn">
        <v-btn class="contact"> Rejoindre Le Programme </v-btn>
      </div>
    </div>
  </v-card>
</template>
